    ...
    if (!pool) {
        ...
        if (process.env.DATABASE_URL) {
            ...
            if (!user || !password || !database) {
                throw new Error('Configuration de base de données manquante. ' + 'Veuillez définir DB_USER, DB_PASSWORD, DB_NAME dans .env.local ' + 'ou utiliser DATABASE_URL.');
            }
            config = {
                host,
                user,
        ...
        pool = new __TURBOPACK__imported__module__$5b$externals$5d2f$pg__$5b$external$5d$__$28$pg$2c$__esm_import$2c$__$5b$project$5d2f$node_modules$2f$pg$29$__["Pool"](config);
...
async function getCachedTransactions(lat, lng, radius, limit, offset) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unstable_cache"])(async ()=>{
        const pool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPool"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5bfddd55._.js.map